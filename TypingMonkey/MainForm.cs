...
namespace TypingMonkey
{
    ...
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            //StringBuilder sb = new StringBuilder(TypingMonkey.legalCharacters);

            //for(int i=0x4e00;i<0x9fa5;++i)
            //{
            //    byte[] vs = BitConverter.GetBytes(i);
            //    sb.Append(UnicodeEncoding.Unicode.GetString(vs).Replace("\0",""));
            //}
            //TypingMonkey.legalCharacters = sb.ToString();
        }
